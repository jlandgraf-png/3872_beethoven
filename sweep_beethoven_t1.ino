...
// Decleration of start_angle [sweep_function]
volatile int start_angle_1 = 0;
volatile int start_angle_2 = 0;
...
void sweep_1(int end1){
if(end1>180 || end1<0){
  lcd.print("Servo  write(args)  Error");
  //debug statment if args() not within range
  // avoid jitter if invalid args
  }
